#
# gcc-lion-opts.sh	Shell script for configuring MEX-file creation script,
#                       mex, customized for Mac OS X 10.7 Lion.  This is
#                       really just a hack to get C files to compile on
#                       Lion; it will need further modifications for C++
#                       and Fortran, or for other architectures.  See INSTALL.
#
...
# and followed by ':'.
#
#SELECTION_TAG_MEX_OPT: Template Options file for building gcc MEX-files on Lion
#
